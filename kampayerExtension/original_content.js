...
chrome.runtime.sendMessage({sent_from:'con', prod_name:prod_name, curr_url:curr_url},function (response)
{
	...
	for (i=0, len = stores.length; i<len; i++)
	{
		...
		urlTemp = "#"//decodeURL(storeSpecs[1])
		alert(storeSpecs[1]);
		...
		if (count == 0){	 count = count +1; dropdown_menu = dropdown_menu + '<ul class="dropdown-menu" style="height:400px; overflow-y:scroll;"><li><a href="'+storeSpecs[1]+'">' + storeSpecs[0] + ',' + storeSpecs[2] + ',' + storeSpecs[3] + '</a></li>';}
		else { 	count = count+1;dropdown_menu = dropdown_menu + '<li class="divider"></li><li><a href="'+urlTemp+'">'+ storeSpecs[0] + ',' + storeSpecs[2] + ',' + storeSpecs[3] + '</a></li>';}
			...
			if (count == 0){	 count = count +1; dropdown_menu = dropdown_menu + '<ul class="dropdown-menu" style="height:400px; overflow-y:scroll;"><li><a href="'+storeSpecs[1]+'">' + storeSpecs[0] + ',' + storeSpecs[2] + ',' + storeSpecs[3] + '</a></li>';}
		else { 	count = count+1;dropdown_menu = dropdown_menu + '<li class="divider"></li><li><a href="'+storeSpecs[1]+'">'+  storeSpecs[0] + ',' + storeSpecs[2] + ',' + storeSpecs[3] + '</a></li>';}
		
		}
		
		// href="'+storeSpecs[1] +'"
		//<a href="'+storeSpecs[1] +'">'+ storeSpecs[0] + ',' + storeSpecs[2] + ',' + storeSpecs[3] + '</a>
	//alert(stores + '----' + storeSpecs[3] + '---' + bestPrice+'----'+ count);
	}
	//alert(stores + '-------' + bestPrice+'----'+ count);
	
	//dropdown_menu = dropdown_menu + '<ul class="dropdown-menu"><li><a href="#">' + pr_client + ',' + pr_color + ',' + pr_price + '</a></li>';
	
	//dropdown_menu = dropdown_menu + '<li><a href="#">'+ pr_client + ',' + pr_color + ',' + pr_price + '</a></li>';
	
	///////////////////////////<ul class="dropdown-menu"><li><a href="#">Flipkart</a></li><li class="divider"></li><li><a href="#">Amazon</a></li><li class="divider"></li><li><a href="#">Infibeam</a></li></ul>
